...
namespace OnlineMinion.DataStore.Migrations
{
    ...
    [Migration("20230826165545_CHANGE_BaseTransaction_validation_and_CreatedAt_value_generation")]
    partial class CHANGE_BaseTransaction_validation_and_CreatedAt_value_generation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineMinion.Data.Entities.Shared.BaseTransaction", b =>
                {
                    b.HasOne("OnlineMinion.Data.Entities.Shared.BasePaymentSpec", "PaymentInstrument")
                        .WithOne()
                        .HasForeignKey("OnlineMinion.Data.Entities.Shared.BaseTransaction", "PaymentInstrumentId")
